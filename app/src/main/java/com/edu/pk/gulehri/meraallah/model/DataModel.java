...
public class DataModel {
    ...
    public static DataModel[] QURAN_SURAH_PAGES_LIST = {
            new DataModel("فاتِحَةُ ", "1", "", 1),
            new DataModel("البَقَرة", "2", "", 1),
            new DataModel("آل عِمران", "45", "", 1),
            new DataModel("النِّســاء", "69", "", 1),
            new DataModel("المَـائِدة", "95", "", 1),
            new DataModel("الأنْعـام", "115", "", 1),
            new DataModel("الأعراف", "136", "", 1),
            new DataModel("الأنْفـال", "160", "", 1),
            new DataModel("التـَّوْبَة", "169", "", 1),
            new DataModel("يُونُس", "187", "", 1),
            new DataModel("هُود", "199", "", 1),
            new DataModel("يُوسُف", "212", " ", 1),
            new DataModel("الرَّعد", "225", "", 1),
            new DataModel("اِبراهيم", "231", "", 1),
            new DataModel("الحِجْر", "237", "   ", 1),
            new DataModel("النًّحل", "242", "  ", 1),
            new DataModel("الاِسْرآء", "255", "’   ", 1),
            new DataModel("الكَهْف", "266", "  ", 1),
            new DataModel("مَريَم", "277", " ", 1),
            new DataModel("طه", "284", " ", 1),
            new DataModel("الأنْبيآء", "294", "’  ", 1),
            new DataModel("الحَجّ", "302", "  ", 1),
            new DataModel("المؤمِنون", "311", "’  ", 1),
            new DataModel("النّور", "319", "  ", 1),
            new DataModel("الفُرقان", "329", "  ", 1),
            new DataModel("الشُّـعَراء", "335", "’’  ", 1),
            new DataModel("النَّـمْل", "345", "  ", 1),
            new DataModel("القَصَص", "354", "  ", 1),
            new DataModel("العَنْـكَبُوت", "364", "  ", 1),
            new DataModel("الرُّوم", "371", "  ", 1),
            new DataModel("لُقْمان", "377", " ", 1),
            new DataModel("السَّـجْدة", "381", "  ", 1),
            new DataModel("الأحزاب", "383", "   ", 1),
            new DataModel("ســَبَأ", "393", "’  ", 1),
            new DataModel("فاطِر", "399", "  ", 1),
            new DataModel("يــس", "404", " ", 1),
            new DataModel("الصّــافّات", "410", "    ", 1),
            new DataModel("ص", "417", "", 1),
            new DataModel("الزُّمَر", "422", "", 1),
            new DataModel("غافر", "431", "", 1),
            new DataModel("فُصِّلَت", "439", "", 1),
            new DataModel("الشُّوری", "445", "", 1),
            new DataModel("الزُّخْرُف", "451", "", 1),
            new DataModel("الدُّخان", "457", "", 1),
            new DataModel("الجاثِية", "460", "", 1),
            new DataModel("الأحقاف", "464", "", 1),
            new DataModel("مُحَمّد", "468", "", 1),
            new DataModel("الفَتْح", "472", "’  ", 1),
            new DataModel("الحُجُرات", "477", "  ", 1),
            new DataModel("ق", "479", " ", 1),
            new DataModel("الذ ّارِيات", "482", "  ", 1),
            new DataModel("الطُّور", "485", "  ", 1),
            new DataModel("النَّجْم", "487", "   ", 1),
            new DataModel("القَمَر", "490", "  ", 1),
            new DataModel("الرَّحمن", "493", "   ", 1),
            new DataModel("الواقِعَة", "496", "’  ", 1),
            new DataModel("الحَديد", "499", "  ", 1),
            new DataModel("المُجادَلة", "504", "  ", 1),
            new DataModel("الحَشْر", "507", "  ", 1),
            new DataModel("المُمتَحَنة", "510", "  ", 1),
            new DataModel("الصَّف", "513", "  ", 1),
            new DataModel("الجُّمُعة", "515", "’ ", 1),
            new DataModel("المُنافِقُون", "516", "  ", 1),
            new DataModel("التَّغابُن", "518", "   & ", 1),
            new DataModel("الطَّلاق", "520", "  ", 1),
            new DataModel("التَّحْريم", "522", "  ", 1),
            new DataModel("المُلْك", "524", " –  ", 1),
            new DataModel("القَلـََم", "526", "  ", 1),
            new DataModel("الحَاقّـَة", "529", "  ", 1),
            new DataModel("المَعارِج", "531", "’   ", 1),
            new DataModel("نُوح", "533", " ", 1),
            new DataModel("الجِنّ", "534", "", 1),
            new DataModel("المُزَّمّـِل", "537", "", 1),
            new DataModel("المُدَّثــِّر", "538", "", 1),
            new DataModel("القِيامَة", "540", "", 1),
            new DataModel("الإنسان", "542", "", 1),
            new DataModel("المُرسَلات", "544", "", 1),
            new DataModel("النـَّبأ", "545", "", 1),
            new DataModel("النـّازِعات", "547", "", 1),
            new DataModel("عَبَس", "548", "", 1),
            new DataModel("التـَّكْوير", "550", "", 1),
            new DataModel("الإنفِطار", "551", "", 1),
            new DataModel("المُطـَفِّفين", "552", "     ", 1),
            new DataModel("الإنشِقاق", "553", "   ", 1),
            new DataModel("البُروج", "554", "  ", 1),
            new DataModel("الطّارق", "555", "  ", 1),
            new DataModel("الأعلی", "556", "’   ", 1),
            new DataModel("الغاشِيَة", "556", "  ", 1),
            new DataModel("الفَجْر", "557", "  ", 1),
            new DataModel("البَـلـَد", "559", "", 1),
            new DataModel("الشــَّمْس", "559", "", 1),
            new DataModel("اللـَّيل", "560", "", 1),
            new DataModel("الضُّحی", "561", "", 1),
            new DataModel("الإنشـِراح", "561", "   ", 1),
            new DataModel("التـِّين", "562", "  ", 1),
            new DataModel("العَلـَق", "562", "‘  ", 1),
            new DataModel("القـَدر", "563", "    ", 1),
            new DataModel("البَيِّنَة", "563", "  ", 1),
            new DataModel("الزِّلزال", "564", "  ", 1),
            new DataModel("العـَاديات", "564", "‘  ", 1),
            new DataModel("القارِعَة", "565", "’   ", 1),
            new DataModel("التَكاثـُر", "565", "   ", 1),
            new DataModel("العَصْر", "566", "‘  ", 1),
            new DataModel("الهُمَزَة", "566", "  ", 1),
            new DataModel("الفيل", "566", "", 1),
            new DataModel("قـُرَيْش", "567", "", 1),
            new DataModel("الماعُون", "567", "", 1),
            new DataModel("الكـَوْثَر", "567", "", 1),
            new DataModel("الكافِرون", "568", "", 1),
            new DataModel("النـَّصر", "568", "", 1),
            new DataModel("ٱلْمَسَد", "568", "", 1),
            new DataModel("الإخـْلاص", "569", "", 1),
            new DataModel("الفـَلَق", "569", "", 1),
            new DataModel("النـَّاس", "569", "", 1),
