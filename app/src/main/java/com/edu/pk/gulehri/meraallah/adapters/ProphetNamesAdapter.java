...
import com.edu.pk.gulehri.meraallah.ui.ProphetNamesDetailActivity;

/**
 * Created by Shahid Iqbal on 6/3/2021
 */

public class ProphetNamesAdapter extends RecyclerView.Adapter<ProphetNamesAdapter.NamesHolder> {
    ...
    public void onBindViewHolder(@NonNull NamesHolder holder, int position) {
        ...
        holder.binding.nameArabic.setText(Model.MUHAMMAD[position].getMUHAMMAD_NAMES_ARABIC());
        holder.binding.nameEnglish.setText(Model.MUHAMMAD[position].getMUHAMMAD_NAMES_ENGLISH());

        holder.itemView.setOnClickListener(v -> {
            Intent intent = new Intent(mContext, ProphetNamesDetailActivity.class);
